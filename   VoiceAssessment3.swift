            ...
            VStack(spacing: 0) {
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 0) {
                        ...
                        // Audio Controls (Restart / Stop / Resume)
                        HStack(alignment: .center, spacing: 35) {
                            
                            // Restart Button
                            Button(action: { print("Restart tapped") }) {
                                VStack(spacing: 6) {
                                    ZStack {
                                        Circle()
                            ...
                            // Stop Button
                            Button(action: { print("Stop tapped") }) {
                                VStack(spacing: 6) {
                                    ZStack {
                                        Circle()
                            ...
                            // Resume Button
                            Button(action: { print("Resume tapped") }) {
                                VStack(spacing: 6) {
                                    ZStack {
                                        Circle()
                                            .fill(RecordingPausedColors.controlButtonBg)
