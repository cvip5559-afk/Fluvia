...
struct VoiceAssessmentView: View {
    ...
    var body: some View {
        NavigationStack { // <--- تم إضافة NavigationStack لتمكين الانتقال إلى PausedView
            ZStack {
                    ...
                    ScrollView(showsIndicators: false) {
                        VStack(spacing: 0) {
                            ...
                            HStack(alignment: .center, spacing: 35) {
                                ...
                                // Restart Button (الرجوع للشاشة الأولى)
                                Button(action: {
                                ...
                                // Pause Button (الانتقال للشاشة الثالثة PausedView)
